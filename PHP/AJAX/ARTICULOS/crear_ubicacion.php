<?php
	/*
		DESCRIPCIÓN: SE UTILIZA PARA LLAMAR A LA FUNCIÓN crear_ubicacion (funciones.php) QUE CREA UNA UBICACIÓN EN LA BD DESDE UN FORM Y DEVOLVERLE EL RESULTADO AL NAVEGADOR A TRAVÉS DE AJAX.
		RESULTADO: DEVUELVE HTML EN FUNCIÓN DEL RESULTADO DE LA CONSULTA EN LA BD
		LLAMADA: ES LLAMADA DESDE LA FUNCIÓN DE JAVASCRIPT confirmar_crear_ubicación
		PARÁMETROS:
			- $_POST['campo_codigo']: EMAIL DEL USUARIO. ES LA CLAVE PRIMARIA DE LA BD. NO PUEDE SER NULL
			- $_POST['campo_descripcion']: CONTRASEÑA DEL USUARIO. NO PUEDE SER NULL
			- $_POST['campo_observaciones']: NOMBRE DEL USUARIO. PUEDE SER NULL
	*/
	session_start();
