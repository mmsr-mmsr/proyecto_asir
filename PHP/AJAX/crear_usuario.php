<?php
	/*
		...
		PARÁMETROS:
			- $_POST['campo_email']: EMAIL DEL USUARIO. ES LA CLAVE PRIMARIA DE LA BD. NO PUEDE SER NULL
			- $_POST['campo_password']: CONTRASEÑA DEL USUARIO. NO PUEDE SER NULL
			- $_POST['campo_nombre']: NOMBRE DEL USUARIO. PUEDE SER NULL
