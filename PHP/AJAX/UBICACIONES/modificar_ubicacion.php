<?php
  ...
  if (isset($_SESSION['email']) and isset($_SESSION['password']) and isset($_SESSION['tipo']) and $_SESSION['tipo'] == "administrador") { // COMPROBAR QUE SE HAYA INICIADO SESIÓN Y SEA ADMIN
		...
		if ($resultado_modificacion === True) echo "CODGIO") echo "Se debe modificar una descripción con un código correcto. Prueba a actualizar la página e intentarlo de nuevo.";
